...
Single-run mode (worker):
    ...
    python test_ram.py --precision fp16
...
DEFAULT_LOCAL_MODEL = "/home/saleh/webKinPred/api/UniKP-main/models/protT5_xl/prot_t5_xl_uniref50"
DEFAULT_DOCKER_MODEL = "/app/api/UniKP-main/models/protT5_xl/prot_t5_xl_uniref50"
